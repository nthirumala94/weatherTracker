...
const cli = new _cli.Cli({
  ...
  }, R.pick(['colors', 'score', 'debug', 'port', 'host', 'command'], _commander2.default)),
...
function getOutStream(enableColors) {
  ...
  const out = new _format.StripAnsiTransform();
